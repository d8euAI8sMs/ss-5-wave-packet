...
\begin{document}
    ...
    \section{Анализ результатов}
        ...
        В ходе работы была написана демонстрационная программа (\autoref{fig:mainwindow}) на языке \enquote{C++}, позволяющая исследовать динамику волнового пакета, спектр стационарных уровней энергий и стационарные волновые функции.
        %
        \begin{figure}[h]
            \centering
        ...
        Программа позволяет задать конфигурацию потенциальной ямы, изначального волнового пакета, указать значение орбитального момента. Стационарные уровни энергии определяются автоматически. Возможности ручного предварительного наведения решающей системы по энергии не предусмотрено.

        Рассмотрим некоторые результаты моделирования.

        Известно, что в сферической потенциальной яме волновые функции представляются через функции Бесселя. Построим стационарные волновые функции частицы без орбитального момента в глубокой потенциальной яме. Из \autoref{fig:wavefunc_0} видно, что каждая из волновых функций внешне напоминает функции Бесселя нулевого порядка. Максимальная плотность вероятности обнаружения частицы -- в центре ямы.

        При появлении орбитального момента (\autoref{fig:wavefunc_1}, \autoref{fig:wavefunc_2}) частица отходит от центра ямы, причем чем больше величина орбитального момента, тем дальше уходит частица. Волновые функции также напоминаюи функции Бесселя б\'{о}льших порядков.

        Волновые пакеты, запущенные в яму, расплываются, отражаются от стенок ямы, порождая \enquote{хаотические скачки} плотности вероятности обнаружения частицы в пределах ямы. При малой глубине ямы вся энергия, запущенная в нее, уходит на бесконечность -- ни один уровень энергии не является физически устойчивым. При достаточной глубине ямы в ней появляются стационарные уровни энергии. Стационарный (установившийся) режим \enquote{движения} волнового пакета в яме является суперпозицией \enquote{движений} стационарных волновых функций.

        \begin{figure}[!htb]
            \centering
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_0_1}
                \label{fig:wavefunc_0_1}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_0_2}
                \label{fig:wavefunc_0_2}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_0_3}
                \label{fig:wavefunc_0_3}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_0_s}
                \label{fig:wavefunc_0_s}
            }
            \hspace{8pt}
            %
            \caption[]{
                Глубокая потенциальная яма. Орбитальный момент равен нулю. \subref{fig:wavefunc_0_1}-\subref{fig:wavefunc_0_3} соответствуют первым трем энергетическим уровням. \subref{fig:wavefunc_0_s} -- энергетический спектр. Стробами снизу отмечены границы ямы по энергии, по протяженности, а также граница \enquote{включения} прозрачных граничных условий.
            }
            \label{fig:wavefunc_0}
        \end{figure}
        %
        \begin{figure}[!htb]
            \centering
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_1_1}
                \label{fig:wavefunc_1_1}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_1_2}
                \label{fig:wavefunc_1_2}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_1_3}
                \label{fig:wavefunc_1_3}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_1_s}
                \label{fig:wavefunc_1_s}
            }
            \hspace{8pt}
            %
            \caption[]{
                Глубокая потенциальная яма. Орбитальный момент равен единице. \subref{fig:wavefunc_1_1}-\subref{fig:wavefunc_1_3} соответствуют первым трем энергетическим уровням. \subref{fig:wavefunc_1_s} -- энергетический спектр. Стробами снизу отмечены границы ямы по энергии, по протяженности, а также граница \enquote{включения} прозрачных граничных условий.
            }
            \label{fig:wavefunc_1}
        \end{figure}
        %
        \begin{figure}[!htb]
            \centering
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_2_1}
                \label{fig:wavefunc_2_1}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_2_2}
                \label{fig:wavefunc_2_2}
            }
            \hspace{8pt}
            %
            \subfloat[][]{
                \includegraphics[width=0.45\textwidth]{wavefunc_2_s}
                \label{fig:wavefunc_2_s}
            }
            \hspace{8pt}
            %
            \caption[]{
                Глубокая потенциальная яма. Орбитальный момент равен двум. \subref{fig:wavefunc_2_1}-\subref{fig:wavefunc_2_2} соответствуют первым трем энергетическим уровням. \subref{fig:wavefunc_2_s} -- энергетический спектр. Стробами снизу отмечены границы ямы по энергии, по протяженности, а также граница \enquote{включения} прозрачных граничных условий.
            }
            \label{fig:wavefunc_2}
        \end{figure}
    ...
    \section{Выводы}
        ...
        В ходе работы была написана программа для исследования поведения волнового пакета в сферической потенциальной ямы. Программа также позволяет выводить на экран энергетический спектр ямы и стационарные волновые функции, соответствующие стационарным уровням энергии -- спектральным пикам.

        Были промоделированы несколько случаев. Результаты моделирования соответствуют теоретическим доводам.
